                        ...
                        <ul class="generic-list-item fs-15">
                            <li class="mb-3">
                                <div class="icon-element icon-element-xs shadow-sm d-inline-block mr-2"><svg xmlns="http://www.w3.org/2000/svg" height="19px" viewBox="0 0 24 24" width="19px" fill="#3cb1c6">
                                    ...
                                    </svg></div> +522 672-452-1120
                            </li>
                            <li class="mb-3">
                                <div class="icon-element icon-element-xs shadow-sm d-inline-block mr-2"><svg xmlns="http://www.w3.org/2000/svg" height="19px" viewBox="0 0 24 24" width="19px" fill="#3cb1c6">
                                        <path d="M0 0h24v24H0V0z" fill="none" />
                                        <path d="M22 6c0-1.1-.9-2-2-2H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6zm-2 0l-8 5-8-5h16zm0 12H4V8l8 5 8-5v10z" />
                                    </svg></div><a href="mailto:example@yourwebsite.com" class="d-inline-block">example@yourwebsite.com</a>
                            </li>
                            <li class="mb-3">
                                <div class="icon-element icon-element-xs shadow-sm d-inline-block mr-2"><svg xmlns="http://www.w3.org/2000/svg" height="19px" viewBox="0 0 24 24" width="19px" fill="#3cb1c6">
                                        <path d="M0 0h24v24H0V0z" fill="none" />
                                    ...
                                    </svg></div> Via Ufente, 20 04100 Latina Italy
                            </li>
                        </ul>
