                    ...
                    <div class="tab-pane fade show active" id="user-profile" role="tabpanel" aria-labelledby="user-profile-tab">
                        <div class="user-panel-main-bar">
                            ...
                            <div class="user-panel mb-30px pt-30px border-top border-top-gray">
                                ...
                                <a class="mr-1 icon-element icon-element-sm shadow-sm text-gray hover-y d-inline-block" href="http://{{Auth::user()->website}}" target="_blank" title="Aller sur mon site web">
                                ...
                                <a class="mr-1 icon-element icon-element-sm shadow-sm text-gray hover-y d-inline-block" href="http://{{Auth::user()->facebooklink}}" target="_blank" title="Suivez moi sur Facebook">
                                ...
                                <a class="mr-1 icon-element icon-element-sm shadow-sm text-gray hover-y d-inline-block" href="http://{{Auth::user()->twitterlink}}" target="_blank" title="Suivez moi sur Twitter">
                                ...
                                <a class="mr-1 icon-element icon-element-sm shadow-sm text-gray hover-y d-inline-block" href="http://{{Auth::user()->instalink}}" target="_blank" title="Suivez moi sur Instagram">
                                ...
                                <a class="mr-1 icon-element icon-element-sm shadow-sm text-gray hover-y d-inline-block" href="http://{{Auth::user()->youtubelink}}" target="_blank" title="Suivez moi sur youtube">
                                ...
                                <a class="mr-1 icon-element icon-element-sm shadow-sm text-gray hover-y d-inline-block" href="http://{{Auth::user()->githublink}}" target="_blank" title="Visitez mon profil github">
