            ...
            <div class="col-lg-8">
                <div class="hero-content d-flex align-items-center">
                    <div class="icon-element shadow-sm flex-shrink-0 mr-3 border border-gray">
                        <svg class="svg-icon-color-5" height="30" viewBox="0 0 512 512" width="30" xmlns="http://www.w3.org/2000/svg">
                            <g>
                ...
                <div class="notification-content-wrap">
                    ...
                    <div class="media media-card media--card shadow-none rounded-0 align-items-center bg-transparent">
                        ...
                        <div class="media-body p-0 border-left-0">
                            <h5 class="fs-14 fw-regular"><a href="{{ route('showQuestion', ['id' => $item->id]) }}">{{$item->titre}}</a></h5>
                            <small class="meta d-block lh-24">
                                <span>{{$item->created_at->format('j F Y, H:i')}}</span>
                            </small>
                        </div>
