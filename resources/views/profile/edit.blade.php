                                                ...
                                                <div>
                                                    <div class="file-upload-wrap file--upload-wrap">
                                                        <form method="post" action="{{route('photoEdited')}}" enctype="multipart/form-data">
                                                            @csrf <input type="file" name="file" class="multi file-upload-input"><button type="submit" class="" style="left: 180px; border-color: transparent; background-color:transparent;">
