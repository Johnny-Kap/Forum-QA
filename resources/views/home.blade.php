...
<section class="hero-area bg-dark overflow-hidden section-padding">
    ...
    <div class="generic-img-box generic-img-box-layout-2">
        <img class="lazy" src="/admins/images/img1.jpg" data-src="/admins/images/img1.jpg" alt="image">
        <img class="lazy" src="/admins/images/img2.jpg" data-src="/admins/images/img2.jpg" alt="image">
        <img class="lazy" src="/admins/images/img3.jpg" data-src="/admins/images/img3.jpg" alt="image">
        <img class="lazy" src="/admins/images/img4.jpg" data-src="/admins/images/img4.jpg" alt="image">
        <img class="lazy" src="/admins/images/img7.jpg" data-src="/admins/images/img7.jpg" alt="image">
        <img class="lazy" src="/admins/images/img6.jpg" data-src="/admins/images/img6.jpg" alt="image">
    </div>
</section>
<!--======================================
        END HERO AREA
                ...
                <div class="card card-item hover-y text-center">
                    <div class="card-body">
                        <svg width="70" viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg">
                            <path d="m18.393 38.405c-.055-.674-.09-1.353-.09-2.041a24.887 24.887 0 0 1 43.171-16.888 22.577 22.577 0 0 1 30.826 6.882 18.466 18.466 0 0 1 25.4 23.657 18.459 18.459 0 0 1 -18.184 32.132 18.453 18.453 0 0 1 -25.566 3.314 19.9 19.9 0 0 1 -35.15-2.028 24.895 24.895 0 1 1 -20.4-45.028z" fill="#f0f5f9" />
                            <path d="m1 62.146a24.91 24.91 0 0 0 37.8 21.291 19.892 19.892 0 0 0 35.15 2.02 18.442 18.442 0 0 0 25.565-3.31 18.467 18.467 0 0 0 26.975-20.417 18.461 18.461 0 0 1 -26.976 11.808 18.445 18.445 0 0 1 -25.565 3.31 19.882 19.882 0 0 1 -17.049 9.625c-8.041 0-11.776-2.155-11.509-9.358-3.765 2.285-13.42 4.268-18.141 4.268-12.285 0-23.844-11.866-25.874-23.562a25.252 25.252 0 0 0 -.376 4.325z" fill="#d9e2e9" />
                            <g fill="#2f3a5a">
                            ...
                            <path d="m64 39.039a20.832 20.832 0 0 0 -20.832 20.832v19.3h5.9v-19.3a14.93 14.93 0 1 1 29.859 0v19.3h5.9v-19.3a20.832 20.832 0 0 0 -20.827-20.832z" fill="#84879c" />
                            <path d="m84.831 80.172h-5.9a1 1 0 0 1 -1-1v-19.3a13.93 13.93 0 1 0 -27.859 0v19.3a1 1 0 0 1 -1 1h-5.9a1 1 0 0 1 -1-1v-19.3a21.832 21.832 0 1 1 43.663 0v19.3a1 1 0 0 1 -1.004 1zm-4.9-2h3.9v-18.3a19.832 19.832 0 1 0 -39.663 0v18.3h3.9v-18.3a15.93 15.93 0 1 1 31.859 0z" fill="#2f3a5a" />
                            <rect fill="#fac77c" height="43.593" rx="8.123" width="53.599" x="37.2" y="72.934" />
                            <path d="m90.8 81.053v27.354a8.126 8.126 0 0 1 -8.13 8.119h-37.348a8.091 8.091 0 0 1 -6.61-3.408 7.862 7.862 0 0 0 2.576.421h37.352a8.135 8.135 0 0 0 8.13-8.129v-27.344a8.166 8.166 0 0 0 -1.509-4.722 8.154 8.154 0 0 1 5.539 7.709z" fill="#e5ae5c" />
                            <path d="m82.676 117.527h-37.353a9.133 9.133 0 0 1 -9.123-9.127v-27.342a9.133 9.133 0 0 1 9.123-9.123h37.353a9.133 9.133 0 0 1 9.124 9.123v27.342a9.133 9.133 0 0 1 -9.124 9.127zm-37.353-43.592a7.131 7.131 0 0 0 -7.123 7.123v27.342a7.131 7.131 0 0 0 7.123 7.123h37.353a7.131 7.131 0 0 0 7.124-7.123v-27.342a7.131 7.131 0 0 0 -7.123-7.123z" fill="#2f3a5a" />
                    ...
                    <div class="card-body">
                        <svg width="70" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
                            <g>
                                <g>
                                    <g>
                                        <path d="m395.058 7.5h-254.439c-16.351 0-29.606 13.255-29.606 29.606v437.789c0 16.351 13.255 29.606 29.606 29.606h331.762c16.351 0 29.606-13.255 29.606-29.606v-360.466c0-7.852-3.119-15.383-8.672-20.935l-77.323-77.323c-5.551-5.552-13.082-8.671-20.934-8.671z" fill="#f4fbff" />
                                        <g>
                                            <path d="m493.316 93.494-54.421-54.421v435.822c0 16.351-13.255 29.606-29.606 29.606h63.092c16.351 0 29.606-13.255 29.606-29.606v-360.466c0-7.852-3.119-15.383-8.671-20.935z" fill="#e4f6ff" />
                                        </g>
                                        <path d="m493.316 93.494-77.323-77.323c-2.532-2.532-5.475-4.557-8.672-6.012v73.652c0 10.137 8.218 18.355 18.355 18.355h73.651c-1.454-3.197-3.48-6.14-6.011-8.672z" fill="#e28086" />
                                    </g>
                                    <g>
                                        <g>
                                            <path d="m238.156 355.206h32.205v67.458h-32.205z" fill="#4a80aa" transform="matrix(.707 -.707 .707 .707 -200.548 293.704)" />
                                            <path d="m362.134 459.681-68.185-68.185c-3.907-3.907-10.242-3.907-14.149 0l-22.981 22.981c-3.907 3.907-3.907 10.242 0 14.149l68.185 68.185c10.253 10.253 26.877 10.253 37.13 0 10.254-10.253 10.254-26.877 0-37.13z" fill="#cc9675" />
                                            <circle cx="147.949" cy="282.625" fill="#bed8fb" r="138.005" />
                                            <circle cx="147.949" cy="282.625" fill="#f4fbff" r="108.098" />
                                        </g>
                                        <g>
                                            <g>
                                                <g>
                                                    <g>
                                                        <g>
                                                            <g>
                                                                <g>
                                                                    <path d="m171.088 333.057c-2.719-.341-4.764-2.645-4.776-5.385l-.105-24.931-38.093.161.105 24.931c.012 2.741-2.014 5.061-4.73 5.426 0 0-7.034 24.04 23.9 23.91 30.935-.132 23.699-24.112 23.699-24.112z" fill="#ffcbbe" />
                                                                    <path d="m204.404 340.347c-8.728-3.842-25.205-6.273-33.316-7.291l-.049.061c-12.168 15.221-35.292 15.289-47.55.14-8.102 1.086-24.559 3.656-33.253 7.571-9.038 4.072-14.24 12.968-14.429 22.303 40.774 36.602 102.669 36.788 143.657.558.162-10.334-5.578-19.168-15.06-23.342z" fill="#365e7d" />
                                                                </g>
                                                            </g>
                                                        </g>
                                                    </g>
                                            ...
                                            <g>
                                                <g>
                                                    <path d="m176.889 224.928c0-6.01-4.872-10.883-10.883-10.883h-36.203c-14.551 0-26.347 11.796-26.347 26.347v19.609l8.999 6.899h70.36l8.999-15.154v-12.26c0-6.01-4.872-10.883-10.883-10.883h-.367c-2.03.001-3.675-1.645-3.675-3.675z" fill="#4a80aa" />
                                                    <g>
                                                        <path d="m191.814 251.747-17.265-1.619c-7.326-.687-14.677 1.019-20.952 4.862-5.35 3.277-11.501 5.011-17.775 5.011h-32.366v15.634c0 3.164 2.565 5.729 5.729 5.729.984 0 1.81.758 1.871 1.74 1.189 19.173 17.106 34.357 36.578 34.357 19.49 0 35.418-15.211 36.536-34.408.055-.952.855-1.688 1.808-1.688h.094c3.218 0 5.821-2.609 5.799-5.82-.057-8.626-.057-23.798-.057-23.798z" fill="#ffddce" />
                                                    </g>
                                                </g>
                                            </g>
                                        </g>
                                    </g>
                                    <path d="m315.371 102.166h-148.786c-4.766 0-8.63-3.864-8.63-8.63v-28.744c0-4.766 3.864-8.63 8.63-8.63h148.787c4.766 0 8.63 3.864 8.63 8.63v28.743c0 4.767-3.864 8.631-8.631 8.631z" fill="#ffe07d" />
                                </g>
                                <g>
...
<section class="info-area section--padding">
    <div class="container">
        <div class="text-center">
            <h2 class="section-title pb-3">Assurez-vous que votre entreprise reste sur la bonne voie</h2>
            <p class="section-desc">Voici quelques-uns des types de techniciens que nous aidons.</p>
        </div>
        <div class="row pt-60px align-items-center">
            <div class="col responsive-column-half card card-item case-card text-center">
                <div class="card-body">
                    ...
                    <h5 class="card-title pt-4 pb-2">Ingénieurs DevOps</h5>
            ...
            <div class="col responsive-column-half card card-item case-card text-center">
                <div class="card-body">
                    ...
                    <h5 class="card-title pt-4 pb-2">Scientifiques des données</h5>
                    <p class="card-text">Ceci est juste un simple script créé pour ce modèle unique et cool.</p>
                </div><!-- end card-body -->
            </div><!-- end col -->
            <div class="col responsive-column-half card card-item case-card text-center case-card-is-active">
                <div class="card-body">
                    ...
                    <h5 class="card-title pt-4 pb-2">Ingénieurs en programmation</h5>
                    <p class="card-text">Conçoit et paramètre des logiciels de rédaction automatique.</p>
                </div><!-- end card-body -->
            </div><!-- end col -->
            <div class="col responsive-column-half card card-item case-card text-center">
                <div class="card-body">
                    ...
                    <h5 class="card-title pt-4 pb-2">Équipes de soutien</h5>
                    <p class="card-text">Ceci est juste un simple script créé pour ce modèle unique et cool.</p>
                </div><!-- end card-body -->
            </div><!-- end col -->
            <div class="col responsive-column-half card card-item case-card text-center">
