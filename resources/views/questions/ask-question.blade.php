...
<section class="hero-area bg-white shadow-sm overflow-hidden">
    ...
    <div class="container">
        <div class="hero-content pt-80px pb-80px">
            <h2 class="section-title">Poser une question publique</h2>
        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="card card-item">
                    <form method="post" action="{{route('addQuestion')}}" enctype="multipart/form-data" class="card-body">
                        @csrf
                        <div class="input-box">
                            <label class="fs-14 text-black fw-medium mb-0">Titre de la question *</label>
                            <p class="fs-13 pb-3 lh-20">Soyez précis et imaginez que vous posez une question à une autre personne</p>
                            <div class="form-group">
                                <input class="form-control form--control" type="text" name="title" placeholder="ex. Existe-t-il une fonction R pour trouver l'indice d'un élément dans un vecteur ?" required>
                            </div>
                        </div><!-- end input-box -->
                        <div class="input-box">
                            <div class="d-flex align-items-center justify-content-between">
                                ...
                                <div class="generic-popover d-none">
                                    <h4 class="fs-16 pb-1">Comment taguer</h4>
                                    <p class="pb-2 fs-14">Les Tags aident les bonnes personnes à trouver et à répondre à votre question.</p>
                                    <ul class="generic-list-item generic-list-item-bullet">
                                        <li class="lh-18 text-black-50">Identifiez votre Tags en complétant la phrase "Ma question concerne…"</li>
                                        <li class="lh-18 text-black-50">Inclure les Tags qui sont cruciales pour votre question uniquement, comme<div class="tag-link">c#</div>
                                        </li>
                                    </ul>
                                    <p class="pb-1 fs-14">Si vous ne trouvez pas un Tag:</p>
                                    <p class="fs-14 text-black-50">Postez sans et <a href="#" class="text-color hover-underline" target="_blank">demander à la communauté</a>
                                        pour en créer un pour vous.
                                    </p>
                                </div><!-- end generic-popover -->
                            </div>
                            <div class="form-group">
                                <select class="select-container select--container" name="tags" data-placeholder="Select a Category">
                        ...
                        <div class="input-box">
                            <label class="fs-14 text-black fw-medium mb-0">Choisir le centre d'interet *</label>
                            <p class="fs-13 pb-3 lh-20">Veuillez choisir la section appropriée afin que la question puisse être recherchée facilement.</p>
                            <div class="form-group">
                                <select class="select-container select--container" name="centres" data-placeholder="Select a Category">
                        ...
                        <div class="input-box">
                            ...
                            <p class="fs-13 pb-3 lh-20">Incluez toutes les informations dont quelqu'un aurait besoin pour répondre à votre question</p>
                            <div class="form-group">
                                <textarea class="form-control form--control user-text-editor" name="details" rows="10" cols="40" required></textarea>
            ...
            <div class="col-lg-4">
                <div class="sidebar">
                    <div class="card card-item p-4">
                        <h3 class="fs-17 pb-3">Étape 1: Rédigez votre question</h3>
                        <div class="divider"><span></span></div>
                        <p class="fs-14 lh-22 pb-2 pt-3">La communauté est là pour vous aider avec des problèmes spécifiques de codage, d'algorithme ou de langage.</p>
                        <p class="fs-14 lh-22">Évitez de poser des questions basées sur l'opinion.</p>
                            ...
                            <div class="card">
                                <div class="card-header" id="headingOne">
                                    <button class="btn btn-link fs-15" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                        <span><span class="text-color pr-2 fs-16">1.</span> Résumez le problème</span>
                                ...
                                <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                                    <div class="card-body">
                                        <ul class="generic-list-item generic-list-item-bullet generic-list-item--bullet-2 fs-14">
                                            <li class="lh-18 text-black-50">Inclure des détails sur votre objectif</li>
                                            <li class="lh-18 text-black-50">Décrire les résultats attendus et réels</li>
                                            <li class="lh-18 text-black-50 mb-0">Inclure tous les messages d'erreur</li>
                                        </ul>
                                    </div>
                                </div>
                            </div><!-- end card -->
                            <div class="card">
                                <div class="card-header" id="headingTwo">
                                    <button class="btn btn-link collapsed fs-15" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                        <span><span class="text-color pr-2 fs-16">2.</span> Décrivez ce que vous avez essayé</span>
                                        <i class="la la-angle-down collapse-icon"></i>
                                    </button>
                                </div>
                                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
                                    <div class="card-body">
                                        <p class="fs-14 lh-22 text-black-50">
                                            Montrez ce que vous avez essayé et dites-nous ce que vous avez trouvé (sur ce site ou ailleurs) et pourquoi cela n'a pas répondu à vos besoins. Vous pouvez obtenir de meilleures réponses lorsque vous fournissez des recherches.
                                        </p>
                                    </div>
                                </div>
                            </div><!-- end card -->
                            <div class="card">
                                <div class="card-header" id="headingThree">
                                    <button class="btn btn-link collapsed fs-15" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                        <span><span class="text-color pr-2 fs-16">3.</span> Montrer du code</span>
                                        <i class="la la-angle-down collapse-icon"></i>
                                    </button>
                                </div>
                                <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordion">
                                    <div class="card-body">
                                        <p class="fs-14 lh-22 text-black-50">
                                            Le cas échéant, partagez la quantité minimale de code dont les autres ont besoin pour reproduire votre problème
                                        </p>
                                    </div>
                                </div>
                            </div><!-- end card -->
