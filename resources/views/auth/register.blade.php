...
<section class="sign-up-area pt-80px pb-80px position-relative">
    <div class="container">
        <form method="POST" action="{{ route('register') }}" class="card card-item">
            @csrf
                ...
                <div class="col-lg-5 mx-auto">
                    <div class="form-action-wrapper py-5">
                        ...
                        <div class="form-group">
                            ...
                            <input id="email" type="email" placeholder="Entrer votre Email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email">
